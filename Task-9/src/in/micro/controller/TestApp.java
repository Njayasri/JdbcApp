...
import in.micro.servicefactory.StudentServiceFactory;
...
public class TestApp {
	...
	private static void deleteOperation() {
		...
		private static void selectOperation() {
			...
			if (std != null) {
				...
				System.out.println(std.getSid() + "\t" + std.getSname() + "\t" + std.getSage() );
			} else {
	...
	System.out.print("Enter the student name :: ");
		...
		String msg = studentService.addStudent(sid, sname, sage);
